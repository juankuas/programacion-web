...
botonguardado.forEach(addtofavoritos => {
    addtofavoritos.addEventListener('click', addToFavoritosClickedCompu, addToFavoritosClickedCelu)
})
...
function addToFavoritosClickedCompu(event){
    ...
    var addfav = card.querySelector('.paddfavs').className = "paddfavsNOT"
...
function addToFavoritosClickedCelu(event){
    ...
    addcardtofavoritosCompu(imgcelu, titlemodal, pmodalcelu, addfav)
}
//
...
function addcardtofavoritosCompu(img, cardtitle, cardtext){
    ...
    <div class="card" style="width: 18rem;" id="card1">
        ...
        <div class="card-body">
          ...
          <a id="webinstabut" href="" class="btn btn-outline-primary" target="_blank"><p id="webinstap">Instagram</p></a>
